...
public class SafariBrowserTest {
	public static void main(String[] args) {
		SafariBrowserTestDemo.launchBrowser();
		SafariBrowserTestDemo.navigate();
		SafariBrowserTestDemo.login();
		SafariBrowserTestDemo.minimizeFlyOutWindow();
		SafariBrowserTestDemo.CreateUser();
		SafariBrowserTestDemo.modifyUser();
		SafariBrowserTestDemo.deleteUser();
		SafariBrowserTestDemo.logout();
		SafariBrowserTestDemo.closeApplication();
